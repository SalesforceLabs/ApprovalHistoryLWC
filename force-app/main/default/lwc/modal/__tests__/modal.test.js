...
describe("c-modal", () => {
  ...
  it("verify closing the dialog", () => {
    ...
    const closedialogEvent = jest.fn();
    element.addEventListener("closedialog", closedialogEvent);
    ...
    return Promise.resolve().then(() => {
      ...
      closeIcon.click();
      expect(closedialogEvent).toHaveBeenCalled();
    });
  });
});
