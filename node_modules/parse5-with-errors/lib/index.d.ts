...
declare namespace Errors {
    export interface ParsingError {
        /**
         * Errror message code
         * Description can be found the in the spec: https://html.spec.whatwg.org/#parse-errors
         */
        code: string;
        /**
         * One-based first character line
         */
        startLine: number;
        /**
         * One-based first character column
         */
        startCol: number;
        /**
         * Zero-based first character index
        ...
        startOffset: number;
        /**
         * One-based last character line
         */
        endLine: number;
        /**
         * One-based last character column
         */
        endCol: number;
        /**
         * Zero-based last character index
...
declare namespace Options {
    export interface ParserOptions {
        ...
        /**
         * Function called for each error the parser encounter
         */
        onParseError?: (err: Errors.ParsingError) => void
    }
