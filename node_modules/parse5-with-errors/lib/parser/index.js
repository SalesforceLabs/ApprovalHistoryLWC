...
Parser.prototype._processInputToken = function (token) {
    ...
    if (token.type === Tokenizer.START_TAG_TOKEN && token.selfClosing && !token.ackSelfClosing && !this._isVoidElementToken(token))
...
//Void elements
Parser.prototype._isVoidElementToken = function (token) {
    return HTML.VOID_ELEMENTS[token.tagName];
};
